/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c8b3996f3b7d8961dcca6113e5b247fc)
...
interface __BaseEnv_Env {
	...
	AI_GATEWAY_BASE_URL: "https://gateway.ai.cloudflare.com/v1/58f07fb13c26e83dd6109d957083478d/ai-video-staging" | "https://gateway.ai.cloudflare.com/v1/58f07fb13c26e83dd6109d957083478d/ai-video";
	APP_BASE_URL: "https://api-staging.gokulhansv.workers.dev" | "https://api.gokulhansv.workers.dev";
	PLAYBACK_PROVIDER: "r2";
	ALLOWED_ORIGINS: "https://zellyo-app-staging.gokulhansv.workers.dev" | "https://aividgen-app.gokulhansv.workers.dev,https://admin.gokulhansv.workers.dev";
	PLAY_TOKEN_PACKS_JSON: "{\"tokens_500\":500,\"tokens_1500\":1500,\"tokens_5000\":5000}";
	RENDER_SERVICE: Fetcher /* render-staging */ | Fetcher /* render */;
	GENERATION_PIPELINE: Workflow /* GenerationPipeline from pipeline-staging */ | Workflow /* GenerationPipeline from pipeline */;
	P_VIDEO_GENERATION: Workflow /* PVideoGenerationWorkflow from pipeline-staging */ | Workflow /* PVideoGenerationWorkflow from pipeline */;
	REGEN_IMAGE: Workflow /* RegenerateSceneImage from pipeline-staging */ | Workflow /* RegenerateSceneImage from pipeline */;
	REGEN_VOICE: Workflow /* RegenerateVoiceover from pipeline-staging */ | Workflow /* RegenerateVoiceover from pipeline */;
	REWRITE_SCRIPT: Workflow /* RewriteScript from pipeline-staging */ | Workflow /* RewriteScript from pipeline */;
	DATA_EXPORT_WORKFLOW: Workflow /* DataExportWorkflow from pipeline-staging */ | Workflow /* DataExportWorkflow from pipeline */;
	ACCOUNT_DELETION_WORKFLOW: Workflow /* AccountDeletionWorkflow from pipeline-staging */ | Workflow /* AccountDeletionWorkflow from pipeline */;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		PLAY_TOKEN_PACKS_JSON: "{\"tokens_500\":500,\"tokens_1500\":1500,\"tokens_5000\":5000}";
		RENDER_SERVICE: Fetcher /* render-staging */;
		GENERATION_PIPELINE: Workflow /* GenerationPipeline from pipeline-staging */;
		P_VIDEO_GENERATION: Workflow /* PVideoGenerationWorkflow from pipeline-staging */;
		REGEN_IMAGE: Workflow /* RegenerateSceneImage from pipeline-staging */;
		REGEN_VOICE: Workflow /* RegenerateVoiceover from pipeline-staging */;
		REWRITE_SCRIPT: Workflow /* RewriteScript from pipeline-staging */;
		DATA_EXPORT_WORKFLOW: Workflow /* DataExportWorkflow from pipeline-staging */;
		ACCOUNT_DELETION_WORKFLOW: Workflow /* AccountDeletionWorkflow from pipeline-staging */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_BASE_URL" | "APP_BASE_URL" | "PLAYBACK_PROVIDER" | "ALLOWED_ORIGINS" | "PLAY_TOKEN_PACKS_JSON">> {}
}
