/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7db34433465da2bb401e02bc6633ea89)
...
interface __BaseEnv_Env {
	...
	GENERATION_PIPELINE: Workflow<Parameters<import("./src/index").GenerationPipeline['run']>[0]['payload']>;
	P_VIDEO_GENERATION: Workflow<Parameters<import("./src/index").PVideoGenerationWorkflow['run']>[0]['payload']>;
	REGEN_IMAGE: Workflow<Parameters<import("./src/index").RegenerateSceneImage['run']>[0]['payload']>;
	REGEN_VOICE: Workflow<Parameters<import("./src/index").RegenerateVoiceover['run']>[0]['payload']>;
	REWRITE_SCRIPT: Workflow<Parameters<import("./src/index").RewriteScript['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_BASE_URL" | "APP_BASE_URL">> {}
}
