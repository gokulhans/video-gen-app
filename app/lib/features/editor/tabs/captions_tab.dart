        ...
        return ListView(
          ...
          children: [
            SwitchListTile(
              ...
              onChanged: (value) =>
                  controller.updateCaptions(captions.copyWith(enabled: value)),
            ),
              ...
              children: CaptionPreset.values
                  .map(
                    (preset) => ChoiceChip(
                      ...
                      onSelected: (_) => controller.updateCaptions(
                        captions.copyWith(preset: preset),
                      ),
                    ),
                  )
                  .toList(),
            ...
            SegmentedButton<CaptionPosition>(
              ...
              onSelectionChanged: (selection) => controller.updateCaptions(
                captions.copyWith(position: selection.first),
              ),
            ),
            const SizedBox(height: 20),
            ...
            _ColorRow(
              ...
              onSelected: (color) => controller.updateCaptions(
                captions.copyWith(primaryColor: color),
              ),
            ),
            const SizedBox(height: 20),
            Text(
            ...
            _ColorRow(
              ...
              onSelected: (color) => controller.updateCaptions(
                captions.copyWith(highlightColor: color),
              ),
            ),
            const SizedBox(height: 20),
            Text(
              'Font size: ${captions.fontSize.round()}',
              style: Theme.of(context).textTheme.titleMedium,
            ),
            Slider(
              ...
              onChanged: (value) =>
                  controller.updateCaptions(captions.copyWith(fontSize: value)),
            ),
          ],
        );
      },
